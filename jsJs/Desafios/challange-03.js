...
pessoa.andar = function (metrosCaminhados){
    ...
    if(metrosCaminhados > 0){
        pessoa.andando = true;
        return 'Andando...';
    } 
    else if (metrosCaminhados === undefined || metrosCaminhados === 0) {
...
pessoa.parar = function () {
    ...
    if(pessoa.andando === true){
        pessoa.andando = false;
        return 'Parando por ordem divina!'
    }
    else{
        return 'Ela já está parada, qual a necessidade de invocar esse dignissimo poder?'
    }
}
...
pessoa.nomeCompleto(); //retorna "Thiago Aquino"
...
pessoa.mostraIdade(); // retorna 'Olá, eu tenho 22 anos'
...
pessoa.mostrarPeso(); // retorna peso
...
pessoa.mostrarIdade(); //Agora tem 25 anos
...
pessoa.andando //retorna se a pessoa está andando ou não
...
*/
pessoa.parar() //retorna parando por ordem divina.
...
pessoa.andando // retorna pessoa andando === false
